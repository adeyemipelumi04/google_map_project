...
//! funtion to retreive the autocompleter data from getplaces API of google maps
  getSuggestion(String input) async {
    String kPLACES_API_KEY =
        "AIzaSyBkAD765nBD-Mm_wfzM1W5mUGQ58z5bEW0"; //?Important!!!<<Place your API key Here,pass it as string>>
    String baseURL =
...
//! Page controller for the nice pageview
  ...
  final key = "AIzaSyBkAD765nBD-Mm_wfzM1W5mUGQ58z5bEW0"; //!Important!!!<<Place your API key Here>>
          ...
          Column(children: [
            ...
            Container(
              ...
              child: TextFormField(
                ...
                onEditingComplete: () async {
                  var directions = await MapServices().getDirection(
